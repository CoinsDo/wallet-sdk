...
var upgradeParams = []upgradeParam{
	...
	//{1786531, []byte{0x21, 0x96, 0x51, 0x37}},
...
func sign1(key *btcec.PrivateKey, hash []byte) *ecdsa.Signature {
	s := ecdsa.Sign(key, hash)
...
func blak2b(data, key []byte) (h chainhash.Hash, err error) {
